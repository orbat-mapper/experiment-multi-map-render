...
const cesiumMap = shallowRef<MapWrapper>();
...
function onCesiumMapReady(adapter: MapAdapter) {
  cesiumMap.value = createMapWrapper(adapter);
}
...
function goToPosition(coord: [number, number], zoom: number) {
  ...
  cesiumMap.value?.goToPosition(coord, zoom);
}
</script>
  ...
  <div class="h-full w-full bg-background">
    <ResizablePanelGroup direction="horizontal" class="h-full w-full">
      <ResizablePanel :default-size="20" class="">
        ...
        <div v-if="olMap && mlMap && leafletMap && cesiumMap" class="p-4">
        ...
        <ResizablePanelGroup direction="vertical">
          ...
          <ResizablePanel :default-size="50">
            <ResizablePanelGroup direction="horizontal">
              ...
              <ResizableHandle />
              <ResizablePanel :default-size="50">
                <CesiumMap @ready="onCesiumMapReady" />
              </ResizablePanel>
            </ResizablePanelGroup>
          </ResizablePanel>
        </ResizablePanelGroup>
